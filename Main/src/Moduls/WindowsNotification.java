...
public class WindowsNotification {
    ...
    public static void displayInfo(String Title, String Text) throws AWTException {
    ...
    public static void displayError(String Title, String Text) throws AWTException {
        //Obtain only one instance of the SystemTray object
        SystemTray tray = SystemTray.getSystemTray();
    ...
    public static void displayWarning(String Title, String Text) throws AWTException {
        //Obtain only one instance of the SystemTray object
        SystemTray tray = SystemTray.getSystemTray();
